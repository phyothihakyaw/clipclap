  ...
  return (
    <div className="popup">
      ...
      {booted && ready && (
        <section className="card summary-card">
          <div className="summary-row">
            <span className="summary-label">Harness</span>
            <span className="summary-value">{harnessLabel}</span>
          </div>
          <div className="summary-row">
            <span className="summary-label">Vault</span>
            <span className="summary-value">{vaultName || "Not set"}</span>
          </div>
          {(settings.autoRewrite || settings.autoSaveToObsidian) && (
            <div className="badge-row">
              {settings.autoRewrite && (
                <span className="badge">Auto rewrite</span>
              )}
              {settings.autoSaveToObsidian && (
      ...
      <p className="hint footer-hint">
        Clip via right-click or Alt+Shift+C / Alt+Shift+S.
      </p>
    </div>
  );
}
